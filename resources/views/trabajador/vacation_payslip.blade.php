...
<head>
    ...
    <title>Recibo de Vacaciones - {{ $trabajador }}</title>
    ...
    <style>
        ...
        @media print {
            ...
            .container { box-shadow: none; border: 2px solid #000; margin: 0; }
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="receipt-info">
                <h1>RECIBO DE PAGO DE VACACIONES</h1>
    ...
    <div class="worker-box box">
        <table class="worker-table">
            <tr>
                ...
                <td width="12%" class="label">Período:</td>
                <td width="38%">{{ $periodo }}</td>
            </tr>
            <tr>
