...
<html lang="en">
  <head>
    ...
    <link
      ...
      sizes="180x180"
      href="{{ asset('themes/test-upload/assets/favicon/apple-touch-icon.png') }}"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
      href="{{ asset('themes/test-upload/assets/favicon/favicon-16x16.png') }}"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="32x32"
      href="{{ asset('themes/test-upload/assets/favicon/favicon-32x32.png') }}"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="192x192"
      href="{{ asset('themes/test-upload/assets/favicon/android-chrome-192x192.png') }}"
    />
    <link
      rel="icon"
      type="image/png"
      sizes="512x512"
      href="{{ asset('themes/test-upload/assets/favicon/android-chrome-512x512.png') }}"
    />
    <link rel="icon" type="image/x-icon" href="{{ asset('themes/test-upload/assets/favicon/favicon.ico') }}" />
    <link rel="manifest" href="{{ asset('themes/test-upload/assets/favicon/site.webmanifest') }}" />
    <link
      rel="stylesheet"
    ...
    />
    <link rel="stylesheet" href="{{ asset('themes/test-upload/css/style.css') }}" />
    <link rel="stylesheet" href="{{ asset('themes/test-upload/css/utilities.css') }}" />
  </head>
  <body>
    <header id="hero">
      <!-- Navbar -->
        ...
        <div class="container">
          ...
          <h1 id="logo">
            <a href="https://github.com/UPTP-336-Proyecto-II/Lufra-2020" target="_blank"
              ><img src="{{ asset('themes/test-upload/assets/icono repositorio UPTP.jpg') }}" alt="Your Logo"
            /></a>
          </h1>
          <!-- Navbar links -->
          <ul class="nav-menu">
...
<!-- Agregar el acceso al login cuando esté listo -Adrian-->
            ...
            <div class="theme-switch">
              ...
              <label class="toggle-icons" for="switch">
                <img class="moon" src="{{ asset('themes/test-upload/assets/moon.svg') }}" />
                <img class="sun" src="{{ asset('themes/test-upload/assets/sun.svg') }}" />
              </label>
            </div>
            <!-- Hamburger menu -->
          </ul>
      ...
      <section class="header-container">
        <img
          class="profile-image"
          src="{{ asset('themes/test-upload/assets/logolufra2.jpeg') }}"
          alt=""
        />
...
<p><b>Ser reconocidos como la empresa líder en el occidente venezolano en la distribución de repuestos automotrices y prestación de servicios técnicos, destacando por su responsabilidad, variedad de productos, asesoría técnica y compromiso con el mantenimiento seguro de cada vehículo</b>.</p>
      ...
      <div class="container">
        ...
        <div class="social">
          <a href="https://www.instagram.com/lufra_2020?igsh=N3h6MWtjbTJha3ly" target="_blank"
            ><img src="{{ asset('themes/test-upload/assets/icons8-instagram-50.png') }}" alt="Instagram"
          /></a>
          <br>
    ...
    <script src="{{ asset('themes/test-upload/js/script.js') }}"></script>
  </body>
</html>
